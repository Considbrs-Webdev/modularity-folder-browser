...
class CacheBust
{
    ...
    public static function getRevManifest()
    {
        ...
        if (file_exists($jsonPath)) {
            ...
            echo '<div style="color:red">Error: Assets not built. Go to ' . MODULARITY_FOLDER_BROWSER_PATH . ' and run npm run build. See ' . MODULARITY_FOLDER_BROWSER_PATH . 'README.md for more info.</div>';
        }
    }
}
